        ...
        <div className="flex gap-1 relative flex-wrap justify-center" ref={tooltipRef}>
          ...
          <div className="relative">
            ...
            {activeTooltip === 'weekly' && (
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-[85vw] sm:w-[320px] md:w-[340px] lg:w-[360px] max-w-[90vw] p-1.5 bg-gradient-to-br from-neutral-800 to-neutral-900 text-white text-xs rounded shadow-xl z-50 text-center leading-relaxed">
