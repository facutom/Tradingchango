...
const ExploreCategories: React.FC = () => (
  <div className="mt-12 pt-8 border-t border-neutral-200 dark:border-neutral-800">
    <h3 className="text-lg font-black text-black dark:text-white mb-4 tracking-tight">Explorar Categorías</h3>
...
export const ComparePricesView: React.FC<{ onClose: () => void }> = ({ onClose }) => (
  <div className="p-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-[800px] mx-auto">
    <button onClick={onClose} className="mb-8 text-neutral-400 hover:text-black dark:hover:text-white flex items-center gap-2 font-bold text-[10px] uppercase tracking-widest transition-colors">
      <i className="fa-solid fa-arrow-left"></i> Volver al Inicio
    </button>
    
    <h1 className="text-4xl font-black text-black dark:text-white mb-6 tracking-tighter">Guía de Dispersión de Precios en Argentina</h1>
    
    <div style={{ lineHeight: '1.7' }} className="space-y-6 text-neutral-700 dark:text-neutral-300">
      <p>
      ...
      <h2 className="text-2xl font-black text-black dark:text-white mt-8 mb-4">¿Por qué varía tanto el precio?</h2>
      <p>
      ...
      <h2 className="text-2xl font-black text-black dark:text-white mt-8 mb-4">Cómo aprovechar las diferencias</h2>
      ...
      <div className="my-8 p-6 bg-green-50 dark:bg-green-900/10 rounded-3xl border border-green-100 dark:border-green-900/30">
...
export const HowToSaveView: React.FC<{ onClose: () => void }> = ({ onClose }) => (
  <div className="p-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-[800px] mx-auto">
    ...
    <h1 className="text-4xl font-black text-black dark:text-white mb-6 tracking-tighter">5 Consejos para Compras Inteligentes</h1>
    
    <div style={{ lineHeight: '1.7' }} className="space-y-8 text-neutral-700 dark:text-neutral-300">
      <p className="text-lg">
      ...
      <div className="space-y-6">
        ...
        <div className="p-6 bg-neutral-50 dark:bg-neutral-900 rounded-3xl border border-neutral-100 dark:border-neutral-800">
          <h3 className="text-xl font-black text-black dark:text-white mb-3">2. Stockeo Preventivo</h3>
          <p>
        ...
        <div className="p-6 bg-neutral-50 dark:bg-neutral-900 rounded-3xl border border-neutral-100 dark:border-neutral-800">
          <h3 className="text-xl font-black text-black dark:text-white mb-3">3. Compará por Unidad de Medida</h3>
          <p>
        ...
        <div className="p-6 bg-neutral-50 dark:bg-neutral-900 rounded-3xl border border-neutral-100 dark:border-neutral-800">
          <h3 className="text-xl font-black text-black dark:text-white mb-3">4. Planificá tu Carrito</h3>
          <p>
        ...
        <div className="p-6 bg-neutral-50 dark:bg-neutral-900 rounded-3xl border border-neutral-100 dark:border-neutral-800">
          <h3 className="text-xl font-black text-black dark:text-white mb-3">5. Descargá las Apps de Supermercados</h3>
          <p>
...
export const PriceHistoryView: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  <div className="p-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-[800px] mx-auto">
    ...
    <h1 className="text-4xl font-black text-black dark:text-white mb-6 tracking-tighter">Trazabilidad de Precios: Detectá Ofertas Verdaderas</h1>
    ...
    <div style={{ lineHeight: '1.7' }} className="space-y-6 text-neutral-700 dark:text-neutral-300">
      ...
      <h2 className="text-2xl font-black text-black dark:text-white mt-8 mb-4">¿Por qué es importante?</h2>
      <p>
      ...
      <h2 className="text-2xl font-black text-black dark:text-white mt-8 mb-4">Cómo usar el historial a tu favor</h2>
      <ul className="list-disc pl-6 space-y-3">
      ...
      <h2 className="text-2xl font-black text-black dark:text-white mt-8 mb-4">Nuestra Tecnología</h2>
      <p>
      ...
      <div className="mt-8 p-6 bg-neutral-50 dark:bg-neutral-900 rounded-3xl border border-neutral-100 dark:border-neutral-800">
...
export const WeeklyOffersView: React.FC<{ onClose: () => void; products?: Product[] }> = ({ onClose, products = [] }) => {
  ...
  // Si es un descuento por cantidad (3x2, 2x1, pack), devuelve el texto exacto
  // Si es un descuento tipo "2do al X%" o "X%" devuelve el texto exacto
  ...
  const getDiscountType = (oferta: string): string | null => {
    ...
    // Descuentos tipo "2do al 50%", "70% off", etc - mostrar el texto exacto
    if (lower.includes('2do') || lower.includes('segundo') || lower.includes('%')) return oferta.trim();
    // Si no es ninguno de estos tipos de descuento, no lo mostramos
    return null;
  };
  ...
  // Obtener tipos de descuento únicos disponibles (solo los que existen)
  ...
  const productsWithOffers = products.filter(p => {
    // Solo productos visibles en la web
    if (p.visible_web === false) return false;
    
    // Verificar si tiene oferta_gondola con contenido
    if (p.oferta_gondola && typeof p.oferta_gondola === 'object') {
  ...
  return (
    <div className="p-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-[800px] mx-auto">
      ...
      <h1 className="text-4xl font-black text-black dark:text-white mb-6 tracking-tighter">Ofertas de la Semana</h1>
      ...
      <div style={{ lineHeight: '1.7' }} className="space-y-6 text-neutral-700 dark:text-neutral-300">
        ...
        {/* Filtros - solo mostrar si hay más de una opción */}
        ...
        {hasOffers ? (
          <>
            ...
            <div className="space-y-4">
              {filteredProducts.slice(0, displayCount).map((product, index) => {
                // Obtener las ofertas del producto
          ...
          <div className="my-8 p-6 bg-neutral-50 dark:bg-neutral-900 rounded-3xl border border-neutral-100 dark:border-neutral-800 text-center">
            <h3 className="text-black dark:text-white font-black text-xl mb-3">No hay ofertas con estos filtros</h3>
